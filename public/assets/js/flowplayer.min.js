...
!function (e) {
    ...
    e.fn.flowplayer = function (t, n) {
        ...
        var l = {pick: function (t) {
            ...
            if (is_absolute = /^https?:/.test(c), u.length > 0 && flowplayer.support.video && u[0].pause(), u.remove(), is_absolute || s.rtmp || (c = e("<img/>").attr("src", c)[0].src), o)o.__play(c); else {
                ...
                i.data("origin") && (f.origin = i.data("origin")), is_absolute && delete s.rtmp, e.each(["key", "autoplay", "preload", "rtmp", "loop", "debug", "preload", "splash"], function (e, t) {
                    ...
                    try {
                        if (!o.PercentLoaded())return i.trigger("error", [n, {code: 7, url: s.swf}])
                    } catch (e) {
                    }
    ...
    flowplayer(function (t, n) {
        ...
        t.cuepoints = t.conf.cuepoints || [], t.bind("progress",function (e, r, o) {
            ...
            a = o;
            for (var s, l = t.cuepoints || [], d = 0; d < l.length; d++)s = l[d], isNaN(s) || (s = {time: s}), s.time < 0 && (s.time = t.video.duration + s.time), s.index = d, Math.abs(s.time - o) < .125 * t.currentSpeed && (i(d), n.trigger("cuepoint", [t, s]))
        ...
        if (!flowplayer.support.subtitles || (t.subtitles = a.length && a[0].track, !r.nativesubtitles || "html5" != r.engine)) {
            ...
            if (s) {
                e.get(s,function (n) {
                    for (var a, r, s, l, d = 0, u = n.split("\n"), c = u.length, f = {}; c > d; d++)if (r = o.exec(u[d])) {
...
flowplayer(function (e, o) {
    ...
    if ("file:" == location.protocol && (l = "localhost"), e.load.ed = 1, t.hostname = l, t.origin = i || location.href, i && o.addClass("is-embedded"), "string" == typeof r && (r = r.split(/,\s*/)), r && "function" == typeof key_check && key_check(r, l))t.logo && o.append(n("<a>", {"class": "fp-logo", href: i}).append(n("<img/>", {src: t.logo}))); else {
        ...
        n(".fp-controls", o), e.bind("pause resume finish unload", function (e, o) {
            ...
            /pause|resume/.test(e.type) && "flash" != o.engine && 4 != a && 5 != a ? (s.show().css({position: "absolute", left: 16, bottom: 36, zIndex: 99999, width: 100, height: 20, backgroundImage: "url(" + [".png", "logo", "/", ".net", ".cloudfront", "d32wqyuo10o653", "//"].reverse().join("") + ")"}), o.load.ed = s.is(":visible"), o.load.ed || o.pause()) : s.hide()
        })
    }
});